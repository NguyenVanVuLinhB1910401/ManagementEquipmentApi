...
namespace ManagementEquipment.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IEquipmentTypeRepository equipmentType, IEquipmentRepository equipment, IAssignmentEquipmentRepository assignmentEquipment)
        {
