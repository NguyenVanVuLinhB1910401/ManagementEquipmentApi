...
using ManagementEquipment.Repositories;
using ManagementEquipment.UtilityServices;
...
builder.Services.AddTransient<IAssignmentEquipmentRepository, AssignmentEquipmentRepository>();
